...
<title>后台管理 - 农场租赁及农产品销售管理系统</title>
...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current"><a href="newsselect">农场公告</a></li>
		</ul>
	</div>
</div>
<div id="childNav">
...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">农场租赁及农产品销售管理系统</a> &gt; 管理后台
</div>
	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dt>农场公告管理</dt>
				<dd><em><a href="news-add.jsp">新增</a></em><a href="newsselect">农场公告管理</a></dd>
			</dl>
		</div>
	</div>
	<div class="main">
